        ...
        <tbody className="divide-y divide-slate-100 dark:divide-gray-800">
          {orders.map((order) => (
            <tr key={order.id} className="hover:bg-slate-50 dark:hover:bg-gray-800/30 transition-colors">
              ...
              <td className="px-4 py-3 text-slate-800 dark:text-white font-medium">{order.cashier_name}</td>
              <td className="hidden sm:table-cell px-4 py-3 text-slate-500">{order.customer_name || '—'}</td>
              ...
              <td className="px-4 py-3">
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-gray-700 transition-colors text-slate-400 hover:text-slate-600 dark:hover:text-white"
                >
                  <Eye size={16} />
                </button>
              </td>
