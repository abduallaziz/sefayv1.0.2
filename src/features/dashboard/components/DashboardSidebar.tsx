...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { key: 'adjustments', href: '/dashboard/adjustments', icon: SlidersHorizontal, section: 'inventory', roles: ['superadmin', 'owner', 'manager', 'inventory_clerk'] },
  { key: 'suppliers', href: '/dashboard/suppliers',   icon: Truck,           section: 'purchasing', roles: ['superadmin', 'owner', 'manager', 'inventory_clerk'] },
  { key: 'purchaseOrders', href: '/dashboard/purchase-orders', icon: ClipboardList, section: 'purchasing', roles: ['superadmin', 'owner', 'manager', 'inventory_clerk'] },
  { key: 'goodsReceipts', href: '/dashboard/goods-receipts', icon: PackageCheck, section: 'purchasing', roles: ['superadmin', 'owner', 'manager', 'inventory_clerk'] },
