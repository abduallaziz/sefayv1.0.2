...
import type { WarehouseFilters as IWarehouseFilters } from '../types/warehouse.types';

interface Props {
  filters: IWarehouseFilters;
  onChange: (filters: IWarehouseFilters) => void;
}

export function WarehouseFiltersBar({ filters, onChange }: Props) {
