...
8. One Matrix item at a time. Never combine items without explicit approval.
9. Stop after every item and wait for explicit approval before starting the next.
