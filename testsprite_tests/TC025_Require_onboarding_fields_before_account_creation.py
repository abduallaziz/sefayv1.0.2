...
async def run_test():
    ...
    try:
        ...
        # -> Open the Onboarding page (navigate to the Onboarding page at /en/onboarding).
        ...
        # -> Click the 'Next' button on the onboarding form without entering any data to trigger validation errors.
        # Next button
